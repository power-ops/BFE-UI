"""
Django settings for bfe project.
...
ALLOWED_HOSTS = [x.strip() for x in str.split(config.get('DJANGO', 'ALLOWED_HOSTS', fallback=''), ',') if x.strip()]
...
WSGI_APPLICATION = 'bfe.wsgi.application'
...
ADMIN_REORDER = (
    {'app': 'cluster_conf', 'models': ('cluster_conf.ClusterConfig', 'cluster_conf.ClusterConf')},
    # {'app': 'cluster_conf', },
)
OTP_TOTP_ISSUER = 'Ctrip'
DJANGO_TITLE = 'Ctrip BFE'
BFE_CENTS_PATH = 'certs'
